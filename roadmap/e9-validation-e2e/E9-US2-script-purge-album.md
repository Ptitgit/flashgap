...
En tant que **développeur**, je veux **un script de purge album** afin de **libérer le disque VPS après test**.
...
- [ ] CLI ou endpoint admin protégé par secret
- [ ] Supprime objets MinIO + lignes DB pour un `albumId`
- [ ] Espace disque VPS mesurable avant/après
