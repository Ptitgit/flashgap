# E9-US3 — Documenter go/no-go V1 (Q10, Q12)
...
En tant qu'**équipe**, je veux **documenter le go/no-go V1** afin de **trancher Q10 et Q12**.
...
- [ ] **Décision iOS (BP10)** : documenter le choix retenu parmi TestFlight / Xcode manuel / parc réduit — pas d'engagement avant cette tâche
- [ ] Section runbook : options pour ~12 iPhones avec avantages/inconvénients
- [ ] Rappel risque absence de backup (Q12 / BP9 — choix confirmé : pas de backup)
- [ ] Recommandations du cadrage reprises ; lien [décisions techniques](../../docs/decisions-techniques.md)
