# E5-US3 — Pas d'enregistrement dans la galerie système

| Champ | Valeur |
| --- | --- |
| **Epic** | [E5 — Mobile — capture photo HD in-app](./README.md) |
| **Statut** | `todo` |
| **Dépendances** | E4 |

## User story

En tant qu'**invité**, je veux **que mes photos ne soient pas enregistrées dans Photos** afin de **respecter « pas de fuite galerie »**.
...
Tests sur la logique de capture/compression (mocks `expo-camera` / `FileSystem`) avant l'UI caméra.
...
- [ ] Aucun appel `MediaLibrary.saveAsync`
- [ ] Pas de `expo-media-library` en écriture
- [ ] Test manuel : album Photos iOS/Android inchangé après 10 captures
