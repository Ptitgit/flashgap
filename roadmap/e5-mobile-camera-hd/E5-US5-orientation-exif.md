...
En tant que **développeur**, je veux **gérer orientation/EXIF** afin que **la galerie affiche correctement**.
...
- [ ] Photos affichées avec la bonne orientation après upload
- [ ] Correction côté mobile avant upload si nécessaire (rotation)
