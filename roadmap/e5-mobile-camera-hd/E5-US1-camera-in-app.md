# E5-US1 — Caméra in-app plein écran
...
En tant qu'**invité**, je veux **ouvrir la caméra in-app** afin de **prendre des photos HD**.
...
- [ ] `expo-camera` en plein écran
- [ ] Résolution maximale supportée par l'appareil
- [ ] Bouton capture → fichier temporaire
