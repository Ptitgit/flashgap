# E5-US4 — Aperçu après capture (reprendre / envoyer)
...
En tant qu'**invité**, je veux **un aperçu après capture** afin de **confirmer ou reprendre**.
...
- [ ] Écran preview avec actions Reprendre et Envoyer
- [ ] Envoyer déclenche la queue upload (E6)
- [ ] Compteur photos envoyées / quota (ex. 42/100)
