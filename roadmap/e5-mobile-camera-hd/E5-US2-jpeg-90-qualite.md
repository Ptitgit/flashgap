# E5-US2 — JPEG qualité 90 % sans downscale
...
En tant que **produit**, je veux **des JPEG à 90 % de qualité** afin de **respecter la spec Q5**.
...
- [ ] Compression qualité 0.9
- [ ] Pas de downscale avant upload
- [ ] Vérification manuelle : taille ~3–6 Mo, résolution native (métadonnées EXIF)
