...
En tant qu'**invité**, je veux **identifier qui a pris chaque photo** afin de **retrouver mes amis**.
...
- [ ] Affichage `memberPseudo` sur chaque tuile (donnée API E3-US5)
