...
En tant qu'**invité**, je veux **voir le temps restant avant le reveal** afin de **savoir quand la galerie s'ouvre**.
...
- [ ] Bandeau ou écran countdown basé sur `reveal_at` (UTC)
- [ ] Sync : utiliser `reveal_at` serveur ; option `GET /albums/:id` pour heure serveur
