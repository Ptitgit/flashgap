...
En tant qu'**invité**, je veux **ouvrir une photo en plein écran** afin de **voir en HD**.
...
- [ ] Tap tuile → modal plein écran avec URL signée originale
- [ ] Pinch zoom : nice-to-have (non bloquant V0)
