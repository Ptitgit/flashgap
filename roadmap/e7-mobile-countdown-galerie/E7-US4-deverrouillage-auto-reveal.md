# E7-US4 — Déverrouillage automatique au reveal
...
En tant qu'**invité**, je veux **que la galerie s'ouvre automatiquement au reveal** afin de **ne pas relancer l'app**.
...
- [ ] Poll toutes les 30 s (MVP) sur endpoint album ou photos
- [ ] À `now >= reveal_at` : déverrouillage UI + fetch photos
- [ ] Notification push hors scope V0
