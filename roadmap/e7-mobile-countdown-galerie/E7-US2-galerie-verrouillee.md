# E7-US2 — Galerie verrouillée avant reveal
...
En tant qu'**invité**, je veux **un écran galerie verrouillé avant le reveal** afin de **ne pas spoiler**.
...
- [ ] Message « Galerie disponible à HH:mm »
- [ ] Pas d'aperçu miniature ni d'URL prefetch
- [ ] Pas de contournement par deep link
