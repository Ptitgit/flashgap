# E4-US5 — Configuration URL API par environnement
...
En tant que **développeur**, je veux **configurer l'URL API par environnement** afin de **pointer vers le VPS**.
...
- [ ] Fichiers `.env.development` / `.env.production` documentés
- [ ] Client HTTP centralisé (fetch ou axios) avec base URL
