# E4-US3 — Écran join (code + pseudo)

| Champ | Valeur |
| --- | --- |
| **Epic** | [E4 — Mobile — projet Expo, join album & session](./README.md) |
| **Statut** | `todo` |
| **Dépendances** | E3, E4-US2 |

## User story

En tant qu'**invité**, je veux **saisir le code album et mon pseudo** afin de **rejoindre la soirée**.
...
- [ ] Champs : code (6 car.) et pseudo
- [ ] Appel `POST /albums/:code/join` ; type réponse `JoinAlbumResponse` importé depuis `@flashgap/shared`
- [ ] Persister `token` retourné pour les appels suivants (cf. E4-US4)
- [ ] États loading, erreur réseau, code invalide affichés
- [ ] Navigation vers écran caméra après succès
