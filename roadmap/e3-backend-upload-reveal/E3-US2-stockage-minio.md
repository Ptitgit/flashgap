# E3-US2 — Écriture MinIO par album/membre
...
En tant que **système**, je veux **écrire chaque photo dans MinIO** afin de **garantir l'isolation par album**.
...
- [ ] Clé objet : `albums/{albumId}/members/{memberId}/{uuid}.jpg`
- [ ] Échec MinIO → pas d'entrée DB persistée (rollback ou delete compensatoire)
- [ ] Métadonnées `size_bytes` enregistrées en DB
