# E3-US4 — Reveal gate (photos invisibles avant reveal)
...
En tant qu'**invité**, je veux **que les photos soient invisibles avant le reveal** afin de **respecter l'invariant produit**.
...
- [ ] `GET /albums/:albumId/photos` avant `reveal_at` : liste vide **ou** HTTP 403 (un seul comportement, documenté)
- [ ] `GET /albums/:albumId/photos/:id` : même règle
- [ ] Tests automatisés ou manuels couvrant les deux côtés de `reveal_at`
