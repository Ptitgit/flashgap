# E3-US8 — Validation flux upload (curl / script)
...
En tant que **développeur**, je veux **valider le flux upload via curl** afin de **débloquer le mobile avant V0.3**.
...
- [ ] Doc ou script : upload JPEG ~5 Mo OK
- [ ] Avant reveal : pas d'accès aux photos
- [ ] Après reveal : URL signée téléchargeable (curl -O)
