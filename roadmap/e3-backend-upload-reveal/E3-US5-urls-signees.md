# E3-US5 — Liste photos et URLs signées après reveal
...
En tant qu'**invité**, je veux **accéder aux photos après le reveal** afin de **voir la galerie**.
...
- [ ] Après `now >= reveal_at` : liste avec `photoId`, `memberPseudo`, `createdAt`, `signedUrl`
- [ ] URL signée MinIO, TTL ex. 1 heure
