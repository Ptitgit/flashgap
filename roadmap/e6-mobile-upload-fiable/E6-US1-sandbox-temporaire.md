# E6-US1 — Sandbox temporaire (cache app)
...
En tant que **système**, je veux **stocker la capture en sandbox temporaire** afin de **ne garder le fichier que jusqu'à upload OK**.
...
- [ ] Chemin `FileSystem.cacheDirectory` (ou équivalent)
- [ ] Pas de copie vers galerie système
