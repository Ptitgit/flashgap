...
En tant qu'**invité**, je veux **un message si le quota est atteint** afin de **comprendre le refus API**.
...
- [ ] Affichage erreur claire sur 429/403 quota
- [ ] Désactivation capture ou bandeau « quota atteint (100/100) »
