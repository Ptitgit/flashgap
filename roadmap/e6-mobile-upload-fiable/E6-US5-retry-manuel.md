...
En tant qu'**invité**, je veux **pouvoir relancer un envoi échoué** afin de **récupérer sans recapturer**.
...
- [ ] Tap sur item `failed` → relance upload
- [ ] Après HTTP 2xx → suppression fichier local
