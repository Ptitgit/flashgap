# E6-US6 — Suppression fichier local après upload
...
En tant que **système**, je veux **supprimer le fichier local après upload confirmé** afin de **respecter le sandbox**.
...
- [ ] Suppression après réponse 2xx de l'API
- [ ] Session test 20 photos : espace disque téléphone stable
