# E6-US2 — États d'envoi visibles (UI)
...
En tant qu'**invité**, je veux **voir l'état d'envoi de ma photo** afin de **savoir si elle est partie**.
...
- [ ] États : `pending`, `uploading`, `done`, `failed`
- [ ] Indicateur UI (icône, barre de progression ou badge)
- [ ] Liste des envois récents accessible depuis l'écran caméra (optionnel)
