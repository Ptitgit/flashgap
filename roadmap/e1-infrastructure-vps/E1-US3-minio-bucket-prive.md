...
- [ ] Bucket créé au démarrage (script init ou entrypoint)
- [ ] Politique deny sur accès public anonyme
- [ ] Credentials MinIO dans variables d'environnement
- [ ] Console MinIO non exposée sur Internet (ou protégée par auth / VPN)
