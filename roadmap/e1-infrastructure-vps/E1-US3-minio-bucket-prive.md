...
En tant que **développeur**, je veux **MinIO configuré en bucket privé** afin de **stocker les JPEG sans URL publique**.
...
- [x] Bucket créé au démarrage (script init ou entrypoint)
- [x] Politique deny sur accès public anonyme
- [x] Credentials MinIO dans variables d'environnement
- [x] Console MinIO non exposée sur Internet (ou protégée par auth / VPN)
...
- Préparer la compatibilité S3 pour une éventuelle migration Scaleway en V2.
