# E2-US5 — Modifier l'heure de reveal
...
En tant qu'**organisateur**, je veux **modifier l'heure de reveal** afin de **programmer la galerie**.
...
- [ ] `PATCH /albums/:id/reveal` body `{ revealAt: ISO8601 }`
- [ ] Authentification organisateur via `organizerSecret` (header ou body)
- [ ] 403 si secret invalide
- [ ] Validation : `revealAt` modifiable tant que l'album n'est pas « révélé » (optionnel en V0)
