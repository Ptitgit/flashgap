# E8-US2 — Build iOS via Xcode (Personal Team)
...
En tant que **développeur**, je veux **builder iOS via Xcode** afin de **tester sur iPhone**.
...
- [ ] `expo prebuild` + ouverture `.xcworkspace`
- [ ] Install sur 1–2 appareils enregistrés (Personal Team)
- [ ] Doc limitations : ~1–2 iPhones sans Developer Program (cadrage Q10)
