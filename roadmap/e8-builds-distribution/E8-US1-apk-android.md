...
En tant que **développeur**, je veux **produire un APK Android** afin de **distribuer aux testeurs**.
...
- [ ] Build via `eas build --profile preview` ou Gradle local
- [ ] APK partageable (lien ou fichier)
- [ ] Doc installation : autoriser sources inconnues
